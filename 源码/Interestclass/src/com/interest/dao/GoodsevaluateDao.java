...
public class GoodsevaluateDao {
	...
	public int addGoodsevaluate(Goodsevaluate goodsevaluate) {
		String sql = "INSERT INTO interest_goodsevaluate(adminuser_id,goods_id,goodsevaluate_star,goodsevaluate_content,goodsevaluate_addtime) " +
	...
	public int updateGoodsevaluate(Goodsevaluate goodsevaluate) {
		String sql = "update interest_goodsevaluate set adminuser_id=:adminuser_id,goods_id=:goods_id,"
	...
	public int deleteGoodsevaluate(int goodsevaluate_id) {
		String sql = "delete from interest_goodsevaluate where goodsevaluate_id=:goodsevaluate_id";
		MapSqlParameterSource sps = new MapSqlParameterSource();
	...
	public List<Goodsevaluate> findGoodsevaluateByPage(Goodsevaluate goodsevaluate, PageBean pageBean) {
		String sql = "select gs.*,a.adminuser_username as adminuser_username,g.course_name as course_name "
				+ "from interest_goodsevaluate gs,interest_adminuser a,interest_course g "
				+ "where gs.adminuser_id=a.adminuser_id and gs.goods_id=g.course_id order by goodsevaluate_addtime asc limit " + pageBean.getStart()
	...
	public int GoodsevaluateCount(Goodsevaluate goodsevaluate) {
		String sql = "select count(*) total from interest_goodsevaluate";
		int totals = 0;
		MapSqlParameterSource sps = new MapSqlParameterSource();
	...
	public List<Goodsevaluate> findGoodsevaluate(Goodsevaluate goodsevaluate) {
		String sql = "select gs.*,a.adminuser_username as adminuser_username,g.course_name as course_name "
				+ "from interest_goodsevaluate gs,interest_adminuser a,interest_course g "
				+ "where gs.adminuser_id=a.adminuser_id and gs.goods_id=g.course_id order by goodsevaluate_addtime asc";
		List<Goodsevaluate> GoodsevaluateList = namedParameterJdbcTemplate.getJdbcOperations().query(sql,new BeanPropertyRowMapper<Goodsevaluate>(Goodsevaluate.class));
		return GoodsevaluateList;
	}
	...
	public Goodsevaluate getGoodsevaluateById(int goodsevaluate_id) {
		String sql = "select gs.*,a.adminuser_username as adminuser_username,g.course_name as course_name "
				+ "from interest_goodsevaluate gs,interest_adminuser a,interest_course g "
				+ "where gs.adminuser_id=a.adminuser_id and gs.goods_id=g.course_id and gs.goodsevaluate_id=:goodsevaluate_id";
		MapSqlParameterSource sps = new MapSqlParameterSource();
		sps.addValue("goodsevaluate_id", goodsevaluate_id);
	...
	public List<Goodsevaluate> findGoodsevaluateByGoodId(int goods_id) {
		String sql = "select gs.*,a.adminuser_username as adminuser_username,g.course_name as course_name "
				+ "from interest_goodsevaluate gs,interest_adminuser a,interest_course g "
				+ "where gs.adminuser_id=a.adminuser_id and gs.goods_id=g.course_id and gs.goods_id=:goods_id order by goodsevaluate_addtime asc";
		MapSqlParameterSource sps = new MapSqlParameterSource();
