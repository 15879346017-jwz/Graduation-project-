...
public class AdminUserDao {
	...
	public AdminUser adminLogin(String adminuser_username, String adminuser_password) {
		String sql = "select * from interest_adminuser where adminuser_username=:adminuser_username and adminuser_password=:adminuser_password and role_id=1";
	...
	public int addAdminUser(AdminUser adminuser) {
		String sql = "INSERT INTO interest_adminuser(adminuser_sn,adminuser_username,"
	...
	public int updateAdminUser(AdminUser adminuser) {
		String sql = "update interest_adminuser set adminuser_sn=:adminuser_sn,"
	...
	public int deleteAdminUser(int adminuser_id) {
		String sql = "delete from interest_adminuser where adminuser_id=:adminuser_id";
		MapSqlParameterSource sps = new MapSqlParameterSource();
	...
	public List<AdminUser> findAdminUserByPage(AdminUser adminuser, PageBean pageBean) {
		String sql = "select * from interest_adminuser where role_id=1 limit " + pageBean.getStart()
	...
	public int AdminUserCount(AdminUser adminuser) {
		String sql = "select count(*) total from interest_adminuser where role_id=1";
		int totals = 0;
		MapSqlParameterSource sps = new MapSqlParameterSource();
	...
	public List<AdminUser> findAdminUserBySearchPage(String searchType, String searchvalue, PageBean pageBean) {
		...
		if (searchType.equals("adminusername")) {//如果搜索类型为按用户名称搜索
			sql = "select * from interest_adminuser where role_id=1 and adminuser_username like '%"+searchvalue+"%' limit " + pageBean.getStart()
					+ "," + pageBean.getPageSize() + "";
		} else if (searchType.equals("adminusersn")) {//如果搜索类型为按用户编号搜索
			sql = "select * from interest_adminuser where role_id=1 and adminuser_sn like '%"+searchvalue+"%' limit " + pageBean.getStart()
					+ "," + pageBean.getPageSize() + "";
		}
		List<AdminUser> AdminUserList = namedParameterJdbcTemplate.getJdbcOperations().query(sql,new BeanPropertyRowMapper<AdminUser>(AdminUser.class));
		return AdminUserList;
	...
	public int AdminUserCountBySearch(String searchType, String searchvalue) {
		...
		if (searchType.equals("adminusername")) {
			sql = "select count(*) total from interest_adminuser where role_id=1 and adminuser_username like '%"+searchvalue+"%'";
		} else if (searchType.equals("adminusersn")) {
			sql = "select count(*) total from interest_adminuser where role_id=1 and adminuser_sn like '%"+searchvalue+"%'";
		}
		int totals = 0;
		totals = (int) namedParameterJdbcTemplate.queryForLong(sql, sps);
		return totals;
	...
	public List<AdminUser> findAdminUsers(AdminUser AdminUser) {
		String sql = "select * from interest_adminuser ";
		List<AdminUser> AdminUserList = namedParameterJdbcTemplate.getJdbcOperations().query(sql,new BeanPropertyRowMapper<AdminUser>(AdminUser.class));
		return AdminUserList;
	}
	...
	public AdminUser getAdminUserById(int AdminUser_id) {
		String sql = "select * from interest_adminuser where adminuser_id=:adminuser_id";
		MapSqlParameterSource sps = new MapSqlParameterSource();
		sps.addValue("adminuser_id", AdminUser_id);
	...
	public int getAdminUserSnToMax() {
		String sql = "select max(adminuser_sn) from interest_adminuser where role_id=1";
		MapSqlParameterSource sps = new MapSqlParameterSource();
		int totals = 0;
		totals = (int) namedParameterJdbcTemplate.queryForLong(sql, sps);
		return totals;
	...
	public int updateadminusertoclose(int adminuser_id) {
		String sql = "update interest_adminuser set adminuser_status=2 where adminuser_id=:adminuser_id";
		MapSqlParameterSource sps = new MapSqlParameterSource();
		sps.addValue("adminuser_id", adminuser_id);
		return namedParameterJdbcTemplate.update(sql, sps);
	}
	...
	public int updateadminusertoopen(int adminuser_id) {
		String sql = "update interest_adminuser set adminuser_status=1 where adminuser_id=:adminuser_id";
		MapSqlParameterSource sps = new MapSqlParameterSource();
		sps.addValue("adminuser_id", adminuser_id);
		return namedParameterJdbcTemplate.update(sql, sps);
	}
	...
	public List<AdminUser> findOlderPasswordByAdminuserId(int adminuser_id, String older_password) {
		String sql = "select adminuser_id,adminuser_password from interest_adminuser where adminuser_id=:adminuser_id and adminuser_password=:older_password";
		MapSqlParameterSource sps = new MapSqlParameterSource();
		sps.addValue("adminuser_id", adminuser_id);
	...
	public int updateadminuserpassword(int adminuser_id, String older_password) {
		String sql = "update interest_adminuser set adminuser_password=:older_password where adminuser_id=:adminuser_id";
		MapSqlParameterSource sps = new MapSqlParameterSource();
		sps.addValue("older_password", older_password);
		sps.addValue("adminuser_id", adminuser_id);
		return namedParameterJdbcTemplate.update(sql, sps);
	...
	public List<AdminUser> findAdminUserByAdminusername(String adminuser_username) {
		String sql = "select * from interest_adminuser where adminuser_username=:adminuser_username";
		MapSqlParameterSource sps = new MapSqlParameterSource();
		sps.addValue("adminuser_username", adminuser_username);
		List<AdminUser> AdminUserList = namedParameterJdbcTemplate.query(sql,sps,new BeanPropertyRowMapper<AdminUser>(AdminUser.class));
		return AdminUserList;
	...
	public int updateAdminUserLasterTimeAndLasterIp(int adminuser_id, String adminuser_lastertime, String adminuser_lasterip) {
		String sql = "update interest_adminuser set adminuser_lastertime=:adminuser_lastertime,adminuser_lasterip=:adminuser_lasterip where adminuser_id=:adminuser_id";
		MapSqlParameterSource sps = new MapSqlParameterSource();
	...
	public AdminUser userLogin(String adminuser_iphone, String adminuser_password) {
		String sql = "select * from interest_adminuser where adminuser_iphone=:adminuser_iphone and adminuser_password=:adminuser_password";
		MapSqlParameterSource sps = new MapSqlParameterSource();
	...
	public List<AdminUser> findUserByIphone(String adminuser_iphone) {
		String sql = "select * from interest_adminuser where adminuser_iphone=:adminuser_iphone";
		MapSqlParameterSource sps = new MapSqlParameterSource();
		sps.addValue("adminuser_iphone", adminuser_iphone);
	...
	public int updateUserInfo(AdminUser adminuser) {
		String sql = "update interest_adminuser set adminuser_username=:adminuser_username,"
	...
	public List<AdminUser> findUserBySearchPage(String searchType, String searchvalue, PageBean pageBean) {
		String sql = null;
		if (searchType.equals("adminusername")) {//如果搜索类型为按用户名称搜索
			sql = "select * from interest_adminuser where role_id=2 and adminuser_username like '%"+searchvalue+"%' limit " + pageBean.getStart()
					+ "," + pageBean.getPageSize() + "";
		} else if (searchType.equals("adminusersn")) {//如果搜索类型为按用户编号搜索
			sql = "select * from interest_adminuser where role_id=2 and adminuser_sn like '%"+searchvalue+"%' limit " + pageBean.getStart()
					+ "," + pageBean.getPageSize() + "";
		}
		List<AdminUser> AdminUserList = namedParameterJdbcTemplate.getJdbcOperations().query(sql,new BeanPropertyRowMapper<AdminUser>(AdminUser.class));
		return AdminUserList;
	...
	public int UserCountBySearch(String searchType, String searchvalue) {
		...
		String sql = null;
		if (searchType.equals("adminusername")) {
			sql = "select count(*) total from interest_adminuser where role_id=2 and adminuser_username like '%"+searchvalue+"%'";
		} else if (searchType.equals("adminusersn")) {
			sql = "select count(*) total from interest_adminuser where role_id=2 and adminuser_sn like '%"+searchvalue+"%'";
		}
		int totals = 0;
		totals = (int) namedParameterJdbcTemplate.queryForLong(sql, sps);
		return totals;
	...
	public List<AdminUser> findUserByPage(AdminUser adminuser, PageBean pageBean) {
		String sql = "select * from interest_adminuser where role_id=2 limit " + pageBean.getStart()
		+ "," + pageBean.getPageSize() + "";
		List<AdminUser> AdminUserList = namedParameterJdbcTemplate.getJdbcOperations().query(sql,new BeanPropertyRowMapper<AdminUser>(AdminUser.class));
		return AdminUserList;
	}
	...
	public int UserCount(AdminUser adminuser) {
		String sql = "select count(*) total from interest_adminuser where role_id=2";
		int totals = 0;
		MapSqlParameterSource sps = new MapSqlParameterSource();
		totals = (int) namedParameterJdbcTemplate.queryForLong(sql, sps);
		return totals;
