...
public class BuyDao {
	...
	public int addBuy(Buy buy) {
		String sql = "INSERT INTO interest_buy(adminuser_id,buy_sn,buy_price,buy_addtime,buy_status,adminuser_username,"
	...
	public int updateBuy(Buy buy) {
		String sql = "update interest_buy set adminuser_id=:adminuser_id,buy_sn=:buy_sn,"
	...
	public int deleteBuy(int buy_id) {
		String sql = "delete from interest_buy where buy_id=:buy_id";
		MapSqlParameterSource sps = new MapSqlParameterSource();
	...
	public List<Buy> findBuyByPage(Buy buy, PageBean pageBean) {
		String sql = "select * from interest_buy limit " + pageBean.getStart()
	...
	public int BuyCount(Buy buy) {
		String sql = "select count(*) total from interest_buy";
		int totals = 0;
		MapSqlParameterSource sps = new MapSqlParameterSource();
	...
	public List<Buy> findBuyBySearchPage(String searchType, String searchvalue, PageBean pageBean) {
		...
		if (searchType.equals("adminusername")) {//如果搜索类型为按用户名称搜索
			sql = "select * from interest_buy where adminuser_username like '%"+searchvalue+"%' limit " + pageBean.getStart()
					+ "," + pageBean.getPageSize() + "";
		}
		List<Buy> BuyList = namedParameterJdbcTemplate.getJdbcOperations().query(sql,new BeanPropertyRowMapper<Buy>(Buy.class));
		return BuyList;
	...
	public int BuyCountBySearch(String searchType, String searchvalue) {
		...
		if (searchType.equals("adminusername")) {
			sql = "select count(*) total from interest_buy where adminuser_username like '%"+searchvalue+"%'";
		}
		int totals = 0;
		totals = (int) namedParameterJdbcTemplate.queryForLong(sql, sps);
		return totals;
	...
	public List<Buy> findBuys(Buy Buy) {
		String sql = "select * from interest_buy ";
		List<Buy> BuyList = namedParameterJdbcTemplate.getJdbcOperations().query(sql,new BeanPropertyRowMapper<Buy>(Buy.class));
		return BuyList;
	}
	...
	public Buy getBuyById(int Buy_id) {
		String sql = "select * from interest_buy where buy_id=:buy_id";
		MapSqlParameterSource sps = new MapSqlParameterSource();
		sps.addValue("buy_id", Buy_id);
	...
	public int updateBuyByIdToYfh(int buy_id) {
		String sql = "update interest_buy set buy_status=3 where buy_id=:buy_id";
		MapSqlParameterSource sps = new MapSqlParameterSource();
		sps.addValue("buy_id", buy_id);
		return namedParameterJdbcTemplate.update(sql, sps);
	}
	...
	public List<Buy> findBuysByAdminUserId(int adminuser_id) {
		String sql = "select * from interest_buy where adminuser_id=:adminuser_id";
		MapSqlParameterSource sps = new MapSqlParameterSource();
	...
	public List<Buy> findBuysByAdminUserIdToWait(int adminuser_id) {
		String sql = "select * from interest_buy where buy_status=2 and adminuser_id=:adminuser_id";
		MapSqlParameterSource sps = new MapSqlParameterSource();
		sps.addValue("adminuser_id", adminuser_id);
		List<Buy> BuyList = namedParameterJdbcTemplate.query(sql,sps,new BeanPropertyRowMapper<Buy>(Buy.class));
		return BuyList;
	...
	public List<Buy> findBuysByAdminUserIdToShouhuo(int adminuser_id) {
		String sql = "select * from interest_buy where buy_status=3 and adminuser_id=:adminuser_id";
		MapSqlParameterSource sps = new MapSqlParameterSource();
		sps.addValue("adminuser_id", adminuser_id);
		List<Buy> BuyList = namedParameterJdbcTemplate.query(sql,sps,new BeanPropertyRowMapper<Buy>(Buy.class));
		return BuyList;
	...
	public List<Buy> findBuysByAdminUserIdToPingjia(int adminuser_id) {
		String sql = "select * from interest_buy where buy_status=4 and adminuser_id=:adminuser_id";
		MapSqlParameterSource sps = new MapSqlParameterSource();
		sps.addValue("adminuser_id", adminuser_id);
		List<Buy> BuyList = namedParameterJdbcTemplate.query(sql,sps,new BeanPropertyRowMapper<Buy>(Buy.class));
		return BuyList;
	...
	public List<Buy> findBuyByUserIdPage(int adminuser_id, PageBean pageBean) {
		String sql = "select * from interest_buy where adminuser_id=:adminuser_id limit " + pageBean.getStart()
		+ "," + pageBean.getPageSize() + "";
		MapSqlParameterSource sps = new MapSqlParameterSource();
		sps.addValue("adminuser_id", adminuser_id);
		List<Buy> BuyList = namedParameterJdbcTemplate.query(sql,sps,new BeanPropertyRowMapper<Buy>(Buy.class));
	...
	public int BuyCountByUserId(int adminuser_id) {
		String sql = "select count(*) total from interest_buy where adminuser_id=:adminuser_id";
		int totals = 0;
		MapSqlParameterSource sps = new MapSqlParameterSource();
		sps.addValue("adminuser_id", adminuser_id);
		totals = (int) namedParameterJdbcTemplate.queryForLong(sql, sps);
	...
	public int updateBuyByIdToShouhuo(int buy_id) {
		String sql = "update interest_buy set buy_status=4 where buy_id=:buy_id";
		MapSqlParameterSource sps = new MapSqlParameterSource();
		sps.addValue("buy_id", buy_id);
		return namedParameterJdbcTemplate.update(sql, sps);
	}
	...
	public int updateBuyByIdToYpj(int buy_id) {
		String sql = "update interest_buy set buy_status=5 where buy_id=:buy_id";
		MapSqlParameterSource sps = new MapSqlParameterSource();
		sps.addValue("buy_id", buy_id);
		return namedParameterJdbcTemplate.update(sql, sps);
	}
