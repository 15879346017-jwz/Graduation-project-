...
if("undefined" != typeof is_bianji){
	if (is_bianji == 1) {
		...
		var tmp_arr=Domain.match(/[\w][\w-]*\.(?:com\.cn|net\.cn|org\.cn|com|cn|co|net|org|gov|cc|biz|info|hn|xyz|hk|us|me|mobi|wang|so|top|vip|ltd|red|ru|shop)(\/|$)/);
		Domain=tmp_arr[0];
                ...
                if(newData.html){
                    ...
                    if(newData.show_style == 58){
                        ...
                        if(newData.show_style ==32 && !$('#shop_and_city_js').length){
                            ...
                            (function(){
                                var src5 = 'https://api.map.baidu.com/getscript?v=2.0&ak=l3M8jnzdfgKoAB0uG2YAFIaoyHukxQ7a&services=&t='+timestamp,
