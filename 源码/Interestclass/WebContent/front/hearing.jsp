	...
	<div class="webBody" state="close" id="webBody" class="bodystyle" data-curbg="wbg_0" data-ver=1>
		...
		<div class="wrapper" id="wrapper" data-curbg="wbg_0">
			...
			<div class="new_mainContainer_tit" id="blankHead" visible="hide" style="display: none">
				...
				<div class="new_notice">听力训练</div>
				<a href="hearing" id="productFenxiang" class="share FT-page FT-page-fenxiang"></a>
			</div>
												...
												<div class="MoBodyC">
													<div class="showcase_Mo bgSetup">
														<div class="showcase">
															<ul>
																<li class="liW wThree">
																	<a href="chinesewords" class="listSetup">
																		<span class="pic picH">
																			<img src="images/6960433_1533783207.png">
																			<div class="textBg"></div>
																		</span>
																		<p class="textfont">汉字学习</p>
																	</a>
																</li>
																<li class="liW wThree">
																	<a href="hearing" class="listSetup">
																		<span class="pic picH">
																			<img src="images/6960423_1533783197.png">
																			<div class="textBg"></div>
																		</span>
																		<p class="textfont">听力训练</p>
																	</a>
																</li>
																<li class="liW wThree">
																	<a href="video" class="listSetup">
																		<span class="pic picH">
																			<img src="images/6960406_1533783168.png">
																			<div class="textBg"></div>
																		</span>
																		<p class="textfont">视频学习</p>
																	</a>
																</li>
																<li class="liW wThree">
																	<a href="#" class="listSetup">
																		<span class="pic picH">
																			<img src="images/6960395_1533783157.png">
																			<div class="textBg"></div>
																		</span>
																		<p class="textfont">每日美文</p>
																	</a>
																</li>
															</ul>
														</div>
						...
						<div class="customModule " data-animate-name="fadeInUp" data-animate-duration="1.00s" data-animate-delay="0.10s">
							...
							<div class="Mo " id="Mo_25" motype='6'>
											...
											<td class="MoBodyM">
												<div class="MoBodyC">
													<div class=" proListmodule_1 " id="prolist_11041810">
														<ul class="q">
															<c:forEach varStatus="i" var="hearing" items="${hearinglist}">
																<li class="list_setup">
																	<div class="pic" style="width: 100px; height: 100px;">
																		<i class="hook"></i>
																		<a href="hearinginfo?hearing_id=${hearing.hearing_id}">
																			<img class="lazy-loading" data-original-src="${hearing.hearing_image}" />
																		</a>
																	</div>
																	<div class="proAttr">
																		<h3>
																			<a href="hearinginfo?hearing_id=${hearing.hearing_id}" class="proName urlfont">
								...
								<div class="pagebar" align="center">
									<ul class="pagination pagination-centered">${pageCode}</ul>
								</div>
								<table class="MoB">
									<tbody>
										<tr>
			...
			<menu class="toolBut q ">
				...
				<c:if test="${currentUser == null || currentUser == ''}">
					<li id="tootMessage" sorts="11" style="width: 25%;">
						<a href="login.html">
							<b class="icon" id="icon_677537"> 
								<img src="images/icon_hearing_off.png" width="20" height="20" />
							</b> 
							<strong>习题练习</strong>
						</a>
					</li>
				...
				<li id="toolMap" sorts="10" style="width: 25%;">
					<a href="video"> 
						<b class="icon" id="icon_677534"> 
							<img src="images/icon_video_off.png" width="20" height="20" />
						</b> 
						<strong>视频学习</strong>
					</a>
				</li>
