		...
		<div id="all_div">
			...
			<div class="margin_t confirm_order">
					<div class="order_list margin_b">
						<dl class="margin_b">
							...
							<dd class="clearfix list_Message">
								<input id="buy_message" type="text" name="remarks" maxlength="45" placeholder="用户留言" value="">
							</dd>
					...
					<div class="add_address_btn">
						...
						<a onclick="checkpay();" class="tijao" id="tijao" style="background-color:#6974f3;"> 确认支付 </a>
						<script type="text/javascript">
							//创建订单
							function checkpay() {
								//生成订单
