		...
		<div class="wrapper_c">
			...
			<div class="max_wrapper_c">
				<div class="settlement_tit">
					<a href="frontuserorder" class="Return1">
				...
				<form method="post" action="userevaluatesave" onsubmit="return formcheckForm();">
					...
					<input type="hidden" id="goods_id" name="goods_id" value="${course.course_id}">
					<div class="bg_color">
						...
						<div class="forward_input">
							<span>课程名称</span>
							<p>
								<input readonly='readonly' id="goods_name" name="goods_name" type="text" maxlength="64" value="${course.course_name}" readonly="readonly">
							</p>
						</div>
						...
						<div class="out" align="center">
							<input type="submit" value="提交" style="background-color:#ff772f;color:#fff;width:300px;height:45px;border:0px;">
						</div>
					</div>
				</form>
			</div>
