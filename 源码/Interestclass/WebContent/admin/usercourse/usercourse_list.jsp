...
<html lang="en">
	<head>
		...
		<script type="text/javascript">
			function usercourseDelete(usercourseId) {
					...
					$.post(
						...
						function(result) {
							...
							if (result.error) {
								...
								alert("删除成功！");
								window.location.href = "usercourselist";
							}
					});
				}
			}
					...
					<div class="page-header">
						<div class="pull-left">
							<ol class="breadcrumb visible-sm visible-md visible-lg">								
								...
								<li><a><i class="icon fa fa-table"></i>管理员管理</a></li>
								<li class="active"><i class="fa  fa-columns"></i>管理员列表</li>
							</ol>						
						</div>
						...
						<div class="col-lg-12">
							<div class="panel panel-default bk-bg-white">
								<div class="panel-heading bk-bg-white">
									<h6>
	                                    <a type="button" class="btn btn-warning m-b-10" href="usercourselist">刷新</a>
									</h6>
									<div class="panel-actions" style="width:430px;margin-top:10px;margin-right:15px;">
										<form name="myForm" method="post" action="usercourselist">
		                                    ...
		                                    <div class="form-group" style="float:left;width:180px;">
												<div class="col-md-9">
													<select id="searchType" name="searchType" class="form-control" size="1" style="width:180px;height:37px;">
														<option value="adminuser_username">用户名称</option>
													</select>
												</div>
											</div>
								...
								<div class="panel-body">
									<div class="table-responsive">	
										<table class="table table-striped table-bordered bootstrap-datatable datatable">
											...
											<tbody>
												<c:forEach varStatus="i" var="usercourse" items="${usercourselist}">					
												<tr>
													<td>${i.count+(page-1)*pageSize }</td>
													<td>
														<img src="${usercourse.course_images}" style="width:100px; height:100px;">
													</td>
	                                                <td>${usercourse.course_name}</td>
	                                                <td>${usercourse.adminuser_username}</td>
											        <td>${usercourse.usercourse_addtime}</td>
											        <td>
											        	<c:if test="${usercourse.usercourse_status==1}">
															报名中
														</c:if>
														<c:if test="${usercourse.usercourse_status==2}">
															报名成功
														</c:if>
														<c:if test="${usercourse.usercourse_status==3}">
															报名失败
														</c:if>
											        </td>
													<td>
														<div style="float:left;margin-right:10px;">
															<a class="btn btn-xs btn-warning" href="usercoursepreSave?usercourseId=${usercourse.usercourse_id}">同意</a>
														</div>
														<div style="float:left;">
											        		<a class="btn btn-xs btn-danger" onclick="usercourseDelete('${usercourse.usercourse_id}')">删除</a>
														</div>
											        </td>
												</tr>
												</c:forEach>
