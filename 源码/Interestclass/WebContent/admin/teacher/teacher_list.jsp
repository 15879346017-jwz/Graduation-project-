						...
						<div class="col-lg-12">
							<div class="panel panel-default bk-bg-white">
								<div class="panel-heading bk-bg-white">
									<h6>
										<a type="button" class="btn btn-success m-b-10" href="teacherpreSave">添加老师</a>
	                                    <a type="button" class="btn btn-warning m-b-10" href="teacherlist">刷新</a>
									</h6>
									<div class="panel-actions" style="width:430px;margin-top:10px;margin-right:15px;">
										<form name="myForm" method="post" action="teacherlist">
		                                    ...
		                                    <div class="form-group" style="float:left;width:180px;">
												<div class="col-md-9">
													<select id="searchType" name="searchType" class="form-control" size="1" style="width:180px;height:37px;">
														<option value="teachername">老师名称</option>
													</select>
												</div>
											</div>
										...
										<table class="table table-striped table-bordered bootstrap-datatable datatable">
											...
											<tbody>
												...
												<tr>
													...
													<td>
														<img src="${teacher.teacher_images}" style="width:100px; height:100px;">
													</td>
	                                                <td>${teacher.teacher_name}</td>
	                                                <td>${teacher.teacher_professor}</td>
											        <td>${teacher.teacher_addtime}</td>
													<td>
														<div style="float:left;margin-right:10px;">
															<a class="btn btn-xs btn-warning" href="teacherpreSave?teacherId=${teacher.teacher_id}">编辑</a>
														</div>
														<div style="float:left;">
											        		<a class="btn btn-xs btn-danger" onclick="teacherDelete('${teacher.teacher_id}')">删除</a>
														</div>
											        </td>
												</tr>
												</c:forEach>
