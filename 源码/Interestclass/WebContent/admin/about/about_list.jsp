						...
						<div class="col-lg-12">
							<div class="panel panel-default bk-bg-white">
								<div class="panel-heading bk-bg-white">
									<h6>
										<!-- <a type="button" class="btn btn-success m-b-10" href="aboutpreSave">添加关于我们</a> -->
	                                    <a type="button" class="btn btn-warning m-b-10" href="aboutlist">刷新</a>
									</h6>
								</div>
								<div class="panel-body">
									<div class="table-responsive">	
										<table class="table table-striped table-bordered bootstrap-datatable datatable">
											...
											<tbody>
												<c:forEach varStatus="i" var="about" items="${aboutlist}">					
												<tr>
													<td>${i.count+(page-1)*pageSize }</td>
	                                                <td>${about.about_content}</td>
													<td>
														<div style="float:left;margin-right:10px;">
															<a class="btn btn-xs btn-warning" href="aboutpreSave?aboutId=${about.about_id}">编辑</a>
														</div>
														<!-- <div style="float:left;">
											        		<a class="btn btn-xs btn-danger" onclick="aboutDelete('${about.about_id}')">删除</a>
														</div> -->
											        </td>
												</tr>
												</c:forEach>
