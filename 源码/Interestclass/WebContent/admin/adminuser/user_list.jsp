						...
						<div class="col-lg-12">
							<div class="panel panel-default bk-bg-white">
								<div class="panel-heading bk-bg-white">
									<h6>
										<a type="button" class="btn btn-success m-b-10" href="userpreSave">添加用户</a>
	                                    <a type="button" class="btn btn-warning m-b-10" href="userlist">刷新</a>
									</h6>
									<div class="panel-actions" style="width:430px;margin-top:10px;margin-right:15px;">
										<form name="myForm" method="post" action="userlist">
												...
												<tr>
													...
													<td>
														<div style="float:left;margin-right:10px;">
															<a class="btn btn-xs btn-warning" href="userpreSave?adminuserId=${adminuser.adminuser_id}">编辑</a>
														</div>
														<div style="float:left;">
											        		<a class="btn btn-xs btn-danger" onclick="userDelete('${adminuser.adminuser_id}')">删除</a>
														</div>
											        </td>
												</tr>
												</c:forEach>
