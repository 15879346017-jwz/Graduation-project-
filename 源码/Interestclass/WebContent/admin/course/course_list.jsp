						...
						<div class="col-lg-12">
							<div class="panel panel-default bk-bg-white">
								<div class="panel-heading bk-bg-white">
									<h6>
										<a type="button" class="btn btn-success m-b-10" href="coursepreSave">添加课程</a>
	                                    <a type="button" class="btn btn-warning m-b-10" href="courselist">刷新</a>
									</h6>
									<div class="panel-actions" style="width:430px;margin-top:10px;margin-right:15px;">
										<form name="myForm" method="post" action="courselist">
										...
										<table class="table table-striped table-bordered bootstrap-datatable datatable">
											...
											<tbody>
												...
												<tr>
													...
													<td>
														<img src="${course.course_images}" style="width:100px; height:100px;">
													</td>
	                                                <td>${course.course_name}</td>
	                                                <td>${course.course_price}</td>
											        <!-- <td>${course.course_applynum}</td> -->
											        <td>${course.course_addtime}</td>
													<td>
														<div style="float:left;margin-right:10px;">
															<a class="btn btn-xs btn-warning" href="coursepreSave?courseId=${course.course_id}">编辑</a>
														</div>
														<div style="float:left;">
											        		<a class="btn btn-xs btn-danger" onclick="courseDelete('${course.course_id}')">删除</a>
														</div>
											        </td>
												</tr>
												</c:forEach>
